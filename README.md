...
# Type of project : PROJECT PHP API PERSONAL WITH LARAVEL
 
## Features
* use php framework Laravel and mysql for store Data in DB

* librairies Fortify for the register and login
